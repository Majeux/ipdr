...
silent! normal! zE
let &fdl = &fdl
let s:l = 164 - ((41 * winheight(0) + 40) / 80)
...
wincmd w
argglobal
if bufexists("inc/algo/frames.h") | buffer inc/algo/frames.h | else | edit inc/algo/frames.h | endif
if &buftype ==# 'terminal'
  silent file inc/algo/frames.h
endif
...
exe 'vert 2resize ' . ((&columns * 181 + 181) / 362)
tabnext 1
badd +190 ~/Documents/master/pebbling-pdr/src/algo/frames.cpp
badd +0 ~/Documents/master/pebbling-pdr/inc/algo/frames.h
