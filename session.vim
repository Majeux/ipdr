...
exe 'vert 2resize ' . ((&columns * 119 + 181) / 363)
exe 'vert 3resize ' . ((&columns * 122 + 181) / 363)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 193 - ((28 * winheight(0) + 41) / 83)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 406 - ((43 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 406
...
balt ~/Documents/master/pebbling-pdr/src/algo/frame.cpp
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
silent! normal! zE
let &fdl = &fdl
let s:l = 291 - ((64 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 291
...
tabnext 1
set stal=1
badd +406 ~/Documents/master/pebbling-pdr/src/algo/frames.cpp
badd +38 ~/Documents/master/pebbling-pdr/inc/algo/frame.h
badd +94 ~/Documents/master/pebbling-pdr/inc/algo/frames.h
...
badd +193 ~/Documents/master/pebbling-pdr/src/algo/pdr.cpp
badd +55 ~/Documents/master/pebbling-pdr/src/algo/frame.cpp
